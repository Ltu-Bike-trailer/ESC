...
impl PinConfig<false, false, false, false> {
    ...
    pub fn new(
        ...
        let (_ppi, gpiote) = conf
            .enable_event_c0::<_, false>(&p1h)
            .enable_event_c1::<_, false>(&p2h)
            .enable_event_c2::<_, false>(&p3h);
...
trait EnableEvent {
    ...
    fn enable_event_c0<T: nrf52840_hal::gpiote::GpioteInputPin, const LOW_TO_HIGH: bool>(
        self,
        pin: &T,
    ) -> Self;
    ...
    ///
    /// If low to high is set this triggers on rising edge other wise it triggers on falling edge.
    fn enable_event_c1<T: nrf52840_hal::gpiote::GpioteInputPin, const LOW_TO_HIGH: bool>(
        self,
        pin: &T,
    ) -> Self;
    ...
    ///
    /// If low to high is set this triggers on rising edge other wise it triggers on falling edge.
    fn enable_event_c2<T: nrf52840_hal::gpiote::GpioteInputPin, const LOW_TO_HIGH: bool>(
        self,
        pin: &T,
    ) -> Self;
    ...
    ///
    /// If low to high is set this triggers on rising edge other wise it triggers on falling edge.
    fn enable_event_c3<T: nrf52840_hal::gpiote::GpioteInputPin, const LOW_TO_HIGH: bool>(
        self,
        pin: &T,
    ) -> Self;
    ...
    ///
    /// If low to high is set this triggers on rising edge other wise it triggers on falling edge.
    fn enable_event_c4<T: nrf52840_hal::gpiote::GpioteInputPin, const LOW_TO_HIGH: bool>(
        self,
        pin: &T,
    ) -> Self;
}
...
impl CurrentManager {
    ...
    pub fn sample(&mut self) -> Result<[i16; 3], ()> {
        Ok([
            self.adc.read_channel(&mut self.p1cs)?,
            self.adc.read_channel(&mut self.p2cs)?,
            self.adc.read_channel(&mut self.p3cs)?,
        ])
    }
}
